...
" Vim syntax file
" put this file in systax directory,replace systemverilog.im
...
syn keyword uvmMethod            start_of_simulation stop suspend
...
" syn keyword verilogStatement     uvm_component " 会将 uvm_component 设置为 verilogStatement，之前的被覆盖
...
syn keyword uvmMethod            mid_apply post_apply pre_apply pre_body
...
syn keyword uvmMethod            do_print send_request get_current_item get_response put_response
...
function! s:SyntaxCreate(name, verilog_syntax)
	 ...
	 syn match  verilogTest       "\.atobin"
	 syn match  verilogTest       "\.atohex\>"
	 syn match  verilogTest       "\.atoi\>"
	 syn match  verilogTest       "\.atooct\>"
	 syn match  verilogTest       "\.atoreal\>"
	 syn match  verilogTest       "\.bintoa\>"
	 syn match  verilogTest       "\.hextoa\>"
	 syn match  verilogTest       "\.itoa\>"
	 syn match  verilogTest       "\.octtoa\>"
	 syn match  verilogTest       "\.realtoa\>"
	 syn match  verilogTest       "\.len\>"
	 syn match  verilogTest       "\.getc\>"
	 syn match  verilogTest       "\.putc\>"
	 syn match  verilogTest       "\.toupper\>"
	 syn match  verilogTest       "\.tolower\>"
	 syn match  verilogTest       "\.compare\>"
	 syn match  verilogTest       "\.icompare\>"
	 syn match  verilogTest       "\.substr\>"
	 syn match  verilogTest       "\.num\>"
	 syn match  verilogTest       "\.exists\>"
	 syn match  verilogTest       "\.first\>"
	 syn match  verilogTest       "\.last\>"
	 syn match  verilogTest       "\.name\>"
	 syn match  verilogTest       "\.index\>"
	 syn match  verilogTest       "\.find\>"
	 syn match  verilogTest       "\.find_first\>"
	 syn match  verilogTest       "\.find_last\>"
	 syn match  verilogTest       "\.find_index\>"
	 syn match  verilogTest       "\.find_first_index\>"
	 syn match  verilogTest       "\.find_last_index\>"
	 syn match  verilogTest       "\.min\>"
	 syn match  verilogTest       "\.max\>"
	 syn match  verilogTest       "\.unique\>"
	 syn match  verilogTest       "\.unique_index\>"
	 syn match  verilogTest       "\.sort\>"
	 syn match  verilogTest       "\.rsort\>"
	 syn match  verilogTest       "\.shuffle\>"
	 syn match  verilogTest       "\.reverse\>"
	 syn match  verilogTest       "\.sum\>"
	 syn match  verilogTest       "\.product\>"
	 syn match  verilogTest       "\.xor\>"
	 syn match  verilogTest       "\.status\>"
	 syn match  verilogTest       "\.kill\>"
	 syn match  verilogTest       "\.self\>"
	 syn match  verilogTest       "\.await\>"
	 syn match  verilogTest       "\.suspend\>"
	 syn match  verilogTest       "\.resume\>"
	 syn match  verilogTest       "\.get\>"
	 syn match  verilogTest       "\.put\>"
	 syn match  verilogTest       "\.peek\>"
	 syn match  verilogTest       "\.try_get\>"
	 syn match  verilogTest       "\.try_peek\>"
	 syn match  verilogTest       "\.try_put\>"
	 syn match  verilogTest       "\.data\>"
	 syn match  verilogTest       "\.eq\>"
	 syn match  verilogTest       "\.neq\>"
	 syn match  verilogTest       "\.next\>"
	 syn match  verilogTest       "\.prev\>"
	 syn match  verilogTest       "\.new\>"
	 syn match  verilogTest       "\.size\>"
	 syn match  verilogTest       "\.delete\>"
	 syn match  verilogTest       "\.empty\>"
	 syn match  verilogTest       "\.pop_front\>"
	 syn match  verilogTest       "\.pop_back\>"
	 syn match  verilogTest       "\.push_front\>"
	 syn match  verilogTest       "\.push_back\>"
	 syn match  verilogTest       "\.front\>"
	 syn match  verilogTest       "\.back\>"
	 syn match  verilogTest       "\.insert\>"
	 syn match  verilogTest       "\.insert_range\>"
	 syn match  verilogTest       "\.erase\>"
	 syn match  verilogTest       "\.erase_range\>"
	 syn match  verilogTest       "\.set\>"
	 syn match  verilogTest       "\.swap\>"
	 syn match  verilogTest       "\.clear\>"
	 syn match  verilogTest       "\.purge\>"
	 syn match  verilogTest       "\.start\>"
	 syn match  verilogTest       "\.finish\>"
